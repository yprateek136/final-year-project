        ...
        <div id="sidebar-wrapper">
            ...
            <ul class="sidebar-nav">
                <li class="sidebar-acc">
                    <a href="<?php echo base_url();?>Dashboard"><i class="fa fa-dashboard"></i>Overview</a>
                </li>
                 <li class="sidebar-acc">
                    <a href="#"><i class="fa fa-picture-o" aria-hidden="true"></i>Suppliers</a>
                    <ul>
                         <li><a href='<?php echo base_url();?>ControllerSuppliers/viewSuppliers'>View </a></li>
                        <li><a  href='<?php echo base_url();?>ControllerSuppliers/addSuppliers'>Add New</a></li>
                 ...
                 <li class="sidebar-acc">
                    ...
                    <ul>
                    <li><a href='<?php echo base_url();?>controllerUsers/viewUsers'>View</a></li>
                        <li><a href='<?php echo base_url();?>controllerUsers/addUsers'>Add New</a></li>
                    </ul>
                </li>
