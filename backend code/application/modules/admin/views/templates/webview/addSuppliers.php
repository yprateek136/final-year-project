<body>
    ...
    <script>
        ...
        function prefill() {
            $.ajax({
                type: 'GET',
                url: "<?= base_url('admin/Api_Ajaxcontroller/fetchSupplier?edit='); ?>" + edit + "",
                data: {
                    id: id,
        ...
        Dropzone.options.eventPhotos = {
            url: "<?= base_url('admin/Api_Ajaxcontroller/upload'); ?>",
            addRemoveLinks: true,
        ...
        function sendData() {
            $.ajax({
                type: 'POST',
                url: "<?= base_url('admin/Api_Ajaxcontroller/sendData'); ?>",
                data: {
                    table_name: 'suppliers',
